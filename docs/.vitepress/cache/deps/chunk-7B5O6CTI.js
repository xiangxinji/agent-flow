...
var Particles = class {
  constructor(engine, container) {
    ...
    this._applyDensity = (options, manualCount2, group, groupOptions) => {
      var _a, _b, _c;
  ...
  setDensity() {
    const options = this._container.actualOptions, groups = options.particles.groups, manualCount2 = options.manualParticles.length;
    for (const group in groups) {
      this._applyDensity(groups[group], manualCount2, group);
    }
    this._applyDensity(options.particles, manualCount2);
  }
...
//# sourceMappingURL=chunk-7B5O6CTI.js.map
